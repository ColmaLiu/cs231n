...
def rnn_step_forward(x, prev_h, Wx, Wh, b):
    ...
    next_h = np.tanh(h_t)
    cache['x'], cache['prev_h'], cache['Wx'], cache['Wh'], cache['b'], cache['h_t'] , cache['next_h']= x, prev_h, Wx, Wh, b, h_t, next_h
...
def rnn_step_backward(dnext_h, cache):
    ...
    x, prev_h, Wx, Wh, b, h_t, next_h = cache['x'], cache['prev_h'], cache['Wx'], cache['Wh'], cache['b'], cache['h_t'], cache['next_h']
    dh_t = dnext_h * (1 - next_h ** 2)
